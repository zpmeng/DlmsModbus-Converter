...
uint32_t read(enum Reg reg)
{
	...
	*	so when float voltage is read we have 2 pairs of 16 bits, out of which 1st pair is least significant
...
/*****************************************************************************
** Function name:		energy_meter_init
**
** Descriptions:		Initialize Energy Meter
**
** parameters:			None
**
** Returned value:		None
