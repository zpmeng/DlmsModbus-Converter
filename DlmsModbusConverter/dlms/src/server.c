...
/*****************************************************************************
** Function name:		 svr_initialize
**
** Descriptions:		 Register all objects inside the buffer
** 						 Here server start
**
** parameters:			 Address of dlmsServerSettings
**
** Returned value:		True or False , False if Object is not Register inside buffer
**
*****************************************************************************/
int svr_initialize(
    dlmsServerSettings* settings)
...
/*****************************************************************************
** Function name:	svr_handleRequest3
**
** Descriptions:     It will handle this command and check command is completed or not.
**					 After when full command come.It will execute.
**
**parameters:		None
**
** Returned value:	None
    ...
    gxByteBuffer* reply)
{
    ...
    //Check frame using inter Character Timeout.
#ifndef DLMS_IGNORE_IEC_HDLC_SETUP
    if (settings->base.interfaceType == DLMS_INTERFACE_TYPE_HDLC && settings->hdlc != NULL && settings->hdlc->interCharachterTimeout != 0)
    {
        ...
        //If frame should be fully received.
