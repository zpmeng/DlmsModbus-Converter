...
/*****************************************************************************
** Function name:		 cosem_init2
**
** Descriptions:		 In side this function OBIS code pass to gxobject structure and stored it.
**
**
** parameters:			 Address of gxobject structure object, Object Types and Logical name(OBIS code)
**
