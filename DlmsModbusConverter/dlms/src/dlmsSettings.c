...
/*****************************************************************************
** Function name:		 svr_init
**
** Descriptions:		 Initialize Server
**
** parameters:			 Address of dlmsServerSetting structure , Logical Name , Interface Type , Frame size , Pdu size , Frame buffer,
**		  				 Frame buffer size , pdu buffer and Pdu buffer size
**
** Returned value:		None
**
*****************************************************************************/
    ...
    unsigned short pduBufferSize)
{
    ...
    //pduBuffer and pduBuferSize are link to dlmsServersettings structure Object
    ...
    //Transaction function Initialize
...
/*****************************************************************************
** Function name:		 cl_init
**
** Descriptions:		 Initialize Client
** 						 All this Argument is stored into dlmsSettings Structure.
**
** parameters:			 Object of dlmsSettings Structure, Logical name (OBIS code), Client address, Server Address, Authentication,
**			   		     Password and InterfaceType.
**
** Returned value:		None
**
******************************************************************************/
    ...
    DLMS_INTERFACE_TYPE interfaceType)
{
    ...
    // Password is link to dlmsSettings structure
